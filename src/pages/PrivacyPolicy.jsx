  ...
  return (
    <div className="font-['Roboto'] bg-[#f5f7fb] overflow-x-hidden" style={{ fontFamily: 'Roboto, sans-serif' }}>
      <section className="relative h-[420px] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[#081b3a]/80" />
        ...
        <div className="relative z-10 h-full flex items-center justify-center text-center px-6">
          <div>
            ...
            <h1 className="text-white text-[52px] md:text-[55px] font-black leading-none">
              Privacy Policy
            </h1>
          </div>
        </div>
        ...
        <div className="max-w-[1100px] mx-auto px-6 lg:px-16">
          <div className="bg-white rounded-[36px] p-8 md:p-12 shadow-xl border-l-[8px] border-[#ff7a00]">
            <PolicySection title="Who we are">
              <p>
                <strong>Suggested text:</strong> Our website address is: https://lionsglobalservices.com/
              </p>
            </PolicySection>
            ...
            <PolicySection title="How long we retain your data">
              <p>
                <strong>Suggested text:</strong> If you leave a comment, the comment and its metadata are retained indefinitely. This is so we can recognize and approve any follow-up comments automatically instead of holding them in a moderation queue.
              </p>
...
function PolicySection({ title, children }) {
  return (
    <div className="mb-10 last:mb-0">
      <h2 className="text-[#081b3a] text-[26px] md:text-[28px] font-black mb-4">
        {title}
      </h2>

      <div className="space-y-6 text-[#5f6b7a] leading-[34px]">
        {children}
      </div>
    </div>
  );
